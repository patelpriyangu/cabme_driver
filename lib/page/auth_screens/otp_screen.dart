...
import 'package:uniqcars_driver/controller/otp_controller.dart';
                          ...
                          if (controller.otpController.value.text.length == 6) {
                            ...
                            PhoneAuthCredential credential =
                                PhoneAuthProvider.credential(
                                    verificationId:
                                        controller.verificationId.toString(),
                                    smsCode:
                                  ...
                                  if (value == true) {
                                    ...
                                    await controller
                                      ...
                                      if (value != null) {
                                        ...
                                        if (userModel.success == "Failed" ||
                                            userModel.success == "failed") {
                                          ShowToastDialog.closeLoader();
                                          ShowToastDialog.showToast(userModel
                                                  .error ??

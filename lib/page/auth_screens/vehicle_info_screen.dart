                          ...
                          children: [
                              ...
                              children: [
                                Expanded(
                                  child: TextFieldWidget(
                                    controller:
                                        controller.modelController.value,
                            ...
                            TextFieldWidget(
                              controller: controller
                                  .councilCarBadgeNumberController.value,
                            ...
                            TextFieldWidget(
                              controller:
                                  controller.numberPlateController.value,
                            ...
                            TextFieldWidget(
                              controller: controller
                                  .councilDriverRegistrationNumberController
                                  .value,
                              hintText:
                                  'Enter Council Driver Registration Number'.tr,
                              title: 'Council Driver Registration Number'.tr,
                              enable: editable,
                            ),
                            TextFieldWidget(
                              controller: controller
                                  .councilDriverBadgeNumberController.value,
            ...
            bottomNavigationBar: isOwnerDriver
                ...
                : Padding(
                    ...
                    child: RoundedButtonFill(
                      ...
                      onPress: () async {
                        if (controller
                            .vehicleTypeController.value.text.isEmpty) {
                          ShowToastDialog.showToast(
                        ...
                        } else if (controller.councilCarBadgeNumberController
                            .value.text.isEmpty) {
                          ShowToastDialog.showToast(
                              "Please enter council car badge number".tr);
                        } else if (controller
                            .numberPlateController.value.text.isEmpty) {
                          ShowToastDialog.showToast(
                              "Please enter vehicle registration number".tr);
                        } else if (controller
                            .councilDriverRegistrationNumberController
                            .value
                            .text
                            .isEmpty) {
                          ShowToastDialog.showToast(
                              "Please enter council driver registration number"
                                  .tr);
                        } else if (controller.councilDriverBadgeNumberController
                            .value.text.isEmpty) {
                          ShowToastDialog.showToast(
                          ...
                          ShowToastDialog.showToast(
                              "Please enter login PIN".tr);
                        } else if (controller
                            .councilRegistrationNumberController
                            .value
                            .text
                            .isEmpty) {
                          ShowToastDialog.showToast(
                              "Please enter DBS number".tr);
                        } else {

...
import 'package:uniqcars_driver/controller/localization_controller.dart';
import 'package:uniqcars_driver/model/language_model.dart';
import 'package:uniqcars_driver/on_boarding_screen.dart';
import 'package:uniqcars_driver/service/localization_service.dart';
              ...
              if (intentType != "dashBoard")
                Padding(
                  ...
                  child: RoundedButtonFill(
                    ...
                    onPress: () {
                      LanguageData languageModel = LanguageData(
                          code: "en", isRtl: "no", language: "English");

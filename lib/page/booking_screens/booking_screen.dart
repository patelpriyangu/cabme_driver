...
class BookingScreen extends StatelessWidget {
                          ...
                          children: [
                            ...
                            controller.userModel.value.userData!.isOwner == "true"
                                ...
                                : bookingData.statut == RideStatus.canceled ||
                                        ...
                                        bookingData.statut == RideStatus.rejected
                                    ? InkWell(
                                        onTap: () {
                                          Get.to(() => BookingDetailsScreen(), arguments: {"bookingModel": bookingData})!.then(
                                            (value) {
                                    ...
                                    : bookingData.statut == RideStatus.confirmed
                                        ...
                                        : bookingData.statut == RideStatus.onRide
                                            ? RoundedButtonFill(
                                                title:
                                                    bookingData.paymentMethod == "Cash" ? "Confirm Cash Payment".tr : "Payment Pending".tr,
                                                height: 5.5,
                              ...
                              : rentalBookingData.status == RideStatus.confirmed
                                  ...
                                  : rentalBookingData.status == RideStatus.onRide &&
                                      ...
                                      : rentalBookingData.status == RideStatus.onRide
                                          ? RoundedButtonFill(
                                              title:
                                                  rentalBookingData.paymentMethod == "Cash" ? "Confirm Cash payment" : "Payment Pending".tr,
                                              height: 5.5,
                                              color: themeChange.getThem() ? AppThemeData.errorDefault : AppThemeData.errorDefault,
                                              textColor: themeChange.getThem() ? AppThemeData.neutral50 : AppThemeData.neutral50,
                                              onPress: () async {
  ...
  void showVerifyRentalPassengerDialog(
      BuildContext context, DarkThemeProvider themeChange, BookingController controller, RentalBookingData rentalBookingData) {
    Get.dialog(
      Dialog(
  ...
  void showVerifyPassengerDialog(
      BuildContext context, DarkThemeProvider themeChange, BookingController controller, BookingData bookingData) {
    Get.dialog(
      Dialog(
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20)),
        child: SizedBox(

...
import 'package:uniqcars_driver/controller/rental_details_controller.dart';
        ...
        builder: (controller) {
          return Scaffold(
            appBar: AppBar(
              ...
              centerTitle: false,
              title: Text(
                controller.rentalBookingData.value.bookingNumber ??
                    "#${controller.rentalBookingData.value.id}",
                  ...
                  : SingleChildScrollView(
                      child: Column(
                        children: [
                          ...
                          controller.rentalBookingData.value.status ==
                                  RideStatus.canceled
                              ? SizedBox()
                              : Container(
                                  width: Responsive.width(100, context),
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        Text(
                                          controller.rentalBookingData.value
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        Text(
                                          "${controller.rentalBookingData.value.packageDetails!.includedHours.toString()} Hr"
                                              .tr,
                                          textAlign: TextAlign.start,
                                          style: AppThemeData.boldTextStyle(
                                              fontSize: 14,
                                ...
                                children: [
                                  ...
                                  ListView.builder(
                                    itemCount: controller
                                        .rentalBookingData.value.tax!.length,
                                    shrinkWrap: true,
                                    physics: NeverScrollableScrollPhysics(),
                                    padding: EdgeInsets.zero,
                                    itemBuilder: (context, index) {
                                      TaxModel taxModel = controller
                                          .rentalBookingData.value.tax![index];
                                      return Padding(
                                        padding:
